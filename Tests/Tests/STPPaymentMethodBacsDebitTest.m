...
- (void)testDecodedObjectFromAPIResponseRequiredFields {
    NSDictionary *paymentMethodJSON = [STPTestUtils jsonNamed:STPTestJSONPaymentMethodBacs];
...
- (void)testDecodedObjectFromAPIResponseMapping {
    NSDictionary *response = [STPTestUtils jsonNamed:STPTestJSONPaymentMethodBacs][@"bacs_debit"];
